...
(e) From (c), what is the correlation between `mpg` and `disp_per_cyl` using the `summarize` function.
...
(j) Do auto-transmission cars have smaller mean values of `mpg`? Compute the sample means and compare. Is the difference statistical significant? State clearly the statistical assumptions that you have made.
